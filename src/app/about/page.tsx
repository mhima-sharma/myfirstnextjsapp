    ...
    <section className="bg-white min-h-screen py-16 px-6 md:px-16 pt-26">
      ...
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
          About <span className="text-black italic border-b-4 border-gray-900">LuxeLoom</span>
        </h1>
      ...
      <div className="max-w-6xl mx-auto mt-10">
        <Image
          src="/herosection.png" // <-- Replace with your LuxeLoom banner image
          alt="About LuxeLoom"
          width={1200}
          height={500}
      ...
      <div className="max-w-6xl mx-auto mt-16 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <Image
            src="/luxeloom-story.jpg" // <-- Replace with your image
            alt="LuxeLoom Story"
            width={500}
            height={400}
