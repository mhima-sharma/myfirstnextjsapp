...
//             <li><a href="/websites" className="hover:text-purple-400 transition">Other Websites</a></li>
...
//           <p className="text-gray-400">📞 +91 79885 43400</p>
//         </div>
//       </div>
// {/* Bottom Bar */}
...
// Import a stylish handwritten Google Font
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6 px-6 md:px-16">
      ...
      <div className="text-center mt-10">
        <p className={`${signatureFont.className} text-purple-400 text-2xl font-bold`}>
          Mahima Sharma
        </p>
        <p className="text-gray-500 text-sm mt-1">Designer & Developer</p>
      </div>
